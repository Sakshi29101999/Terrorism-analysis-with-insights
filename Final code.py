# -*- coding: utf-8 -*-
"""
Created on Mon Sep  7 11:42:13 2020
...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 30 18:32:46 2020
...
def load_data():
  ...
  chart_dropdown_values = {"Country attaked":"country_txt",
                          "Region":"region_txt",
                          "Traget Nationality":"targettype1_txt",
                          "Types of attack":"attacktype1_txt",
                          "Weapon Type":'weaptype1_txt', 
                          "Terrrorist Organisation":"gname"}
...
def create_app_ui():
  ...
  main_layout = html.Div([
    html.Div([
        ...
        html.Br(),
    html.Div([
        html.Button('Click to kill server',id='kill_server',className='button')]),
    html.Div([
        html.Img(src='/assets/bus2.jpg')],style={'margin': 'auto'},className='banner Img'),
  ...
  dcc.Tabs(id="Tabs", value="Map",children=[
    ...
    html.Div([
          ...
          html.H5('Select the Year', id='year_title',style={'color':'White'}),
          dcc.RangeSlider(
                    id='year-slider',
                    min=min(year_list),
                    max=max(year_list),
      ...
      dcc.Tab(label = "Chart Tool", id="chart tool", value="Chart", children=[
          ...
          html.Div([
            ...
            html.Hr(),
            html.Br(),
            html.H5('Select the Year', id='year_title2',style={'color':'Black'}),
            dcc.RangeSlider(
                    id='cyear_slider',
                    min=min(year_list),
                    max=max(year_list),
                    ...
                    marks=year_dict,
                    step=None
                      )],style={'background-image':'url("/assets/tank2.jpg")','background-repeat': 'no-repeat','background-size': '100% 100%'}),
                  html.Br()
              ]),
         ]),
